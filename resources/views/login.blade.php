    ...
    <div class="w-full max-w-screen-lg mx-auto p-6 md:p-8 lg:p-10">
        <div class="flex flex-col md:flex-row justify-between items-start">
            ...
            <div class="w-full md:w-1/2 flex justify-center mt-4 md:mt-0">
                <div style="margin-top: 15%;" class="bg-white p-6 m-4 md:m-6 rounded-lg shadow-lg w-full">
                    <form class="w-full" action="#" method="post">
                        <h1 class="text-xl md:text-3xl font-bold mb-6">Login</h1>
                        <div class="w-full">
                            <input class="w-full my-2 px-4 py-2 border border-gray-400 rounded-md focus:outline-none focus:border-blue-500" type="text" name="userName" placeholder="Username or email" required>
                            <div class="relative">
                        ...
                        <div class="flex flex-col items-center w-full mt-4">
                            <button class="w-full md:w-32 my-2 py-2 px-4 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition duration-300" type="submit">Login</button>
                    ...
                    <div class="flex flex-col items-center w-full">
                        <button class="w-full md:w-32 py-2 px-4 bg-gray-500 text-white rounded-full hover:bg-gray-600 transition duration-300">Register</button>
                    </div>
                </div>
            </div>
        </div>
