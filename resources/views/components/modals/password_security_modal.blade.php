<div id="passwordSecurityModal" class="fixed inset-0 z-40 flex items-center justify-center bg-gray-500 bg-opacity-75 hidden">
    ...
    <div class="flex flex-col w-1/3 z-50 h-auto bg-white rounded-md">
        <div class="p-10">
            <div>
                <h1 class="py-2 text-xl font-semibold sm:py-4 sm:text-2xl md:text-3xl">Password and Security</h1>
            </div>
            <div>
            ...
            <div class="flex flex-col">
                ...
                <a href="#" class="flex w-full bg-gray-700 py-4 text-white text-sm rounded-md border p-2 px-3 hover:bg-gray-500">
            ...
            <div>
                <a href="#" class="flex w-full bg-gray-700 py-4 my-4 text-white text-sm rounded-md border p-2 px-3 hover:bg-gray-500">
                    Login Alerts
                    <div class="flex-grow"></div> <!-- This div will push the arrow to the right -->
                    <div id="arrow" class="ml-2">
                        <img src="{{ asset('img-assets/vectors/arrow.svg') }}" alt="arrow">
