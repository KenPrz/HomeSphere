    ...
    <div class="fixed inset-0 z-40 flex items-center justify-center">
        ...
        <div class="w-full rounded-md bg-white p-4 shadow-lg sm:w-1/2 sm:p-8 md:w-1/3 lg:w-1/4 z-50">
            ...
            <form action="{{route('changeEmail')}}" method="POST" class="mt-4">
                @csrf
                        <input placeholder="Current email" name="currentEmail" type="text" class="w-full border-2 border-color-black py-4 mb-3 px-4 rounded-md">
                        <input placeholder="New email" name="newEmail" type="text" class="w-full border-2 border-color-black py-4 mb-3 px-4 rounded-md">
