    ...
    <form action="{{ route('register') }}" method="POST" class="space-y-4">
        ...
        <div class="flex">
            <input type="text" name="firstName" placeholder="First name" required
                class="flex-1 px-3 py-2 mr-1 rounded border focus:outline-none focus:border-blue-500">
            <input type="text" name="lastName" placeholder="Last name" required
                class="flex-1 px-3 py-2 ml-1 rounded border focus:outline-none focus:border-blue-500">
        </div>
        <div>
        ...
        <div>
            <input type="password" name="confirm_password" placeholder="Confirm Password" id="createAccountPasswordInput" required
                class="w-full px-3 py-2 rounded border focus:outline-none focus:border-blue-500">
        </div>
